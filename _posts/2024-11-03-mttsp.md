...
Our recent work considers finding tight lower bounds for MT-TSP 
{% cite 2025_TRO_Cstar_MTTSP_Allen %}, multiple robots 
{% cite 2025_CASE_MAMTTSP_Allen %}, Dubins vehicles {% cite 2026_ICRA_Dubins_MT_TSP_O_Anoop %} and capacity constraints {% cite 2026_ICAPS_MT_VRP_Anoop %}.
