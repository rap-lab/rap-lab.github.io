...
<figure>
    ...
    <figcaption>Fig.1 - Comparison between the existing MAPF (left) and this work MAPF-AA (right). Stars are final goal locations. Circles are the agents with differnt action duration when moving from one location to another.</figcaption>
</figure>
