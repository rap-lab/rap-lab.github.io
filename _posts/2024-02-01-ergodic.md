...
Finally, to expedite the computation, we also develop a variant called Adaptive SLES, which can adjust the computation based on the similarity of the information maps in the Fourier coefficient space.
