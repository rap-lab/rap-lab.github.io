...
{% bibliography --query @*[title^={A Pareto-Optimal Local Optimization Framework for Multiobjective Ergodic Search}] %}

{% bibliography --query @*[title^={Multi-Agent Multi-Objective Ergodic Search Using Branch and Bound}] %}
