...
[MCPF Exact]({{page.url | relative_url}}#Exact-Algorithms-for-MCPF) 
[MCPF Bounded Sub-optimal]({{page.url | relative_url}}#Bounded-Sub-optimal-Approach-for-MCPF) 
[MCPF with Task Duration]({{page.url | relative_url}}#MCPF-with-Heterogeneous-Task-Duration) 
[MCPF for Tractor-Trailers]({{page.url | relative_url}}#MCPF-for-Tractor-Trailer-Robots-with-Varying-Body-Lengths) 
